...
export class TableDemoComponent implements OnInit {
  ...
  public columns:Array<any> = [
    {title: 'Shipper', name: 'shipper',editable:true, filtering: {filterString: '', placeholder: 'Filter by shipper'}},
    {title: 'Shipment number', name: 'shipment number', editable:true, options:["France", "Venezuela", "Macao"]},
    {title: 'DC info', name: 'dc info', editable: true, editWith: 'number of cartons'},
    {
      title: 'Number of cartons',
      name: 'number of cartons',
      editable: true,
      options: ["Entry", "Junior", "Senior"]
    },
    {title: 'Ship Date', name: 'shipDate', editable: true , showDatePicker:true},
    {title: 'ETA', name: 'eta', editable: true , showDatePicker:true},
    {title: 'Tracking Number', name: 'tracking number', editable: true}
  ];
