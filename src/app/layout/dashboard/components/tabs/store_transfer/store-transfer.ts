...
import { STRowContentComponent } from './row-content/row-content.component';
...
export class StoreTransferComponent implements OnInit {
  ...
  public columns:Array<any> = [
    {title: 'Issuing store', name: 'issuing store',editable:true, filtering: {filterString: '', placeholder: 'Filter by issuing store'}},
    {title: 'Transfer number', name: 'transfer number', editable:true},
    ...
    {title: 'Ship date', name: 'ship date', editable: true , showDatePicker:true}
  ...
  public rowComponent = STRowContentComponent;
